...
parser.add_argument('--checkpoint_path', type=str, default='BDD-512-640/Checkpoint/latest_model_FC-DenseNet103_CamVid.ckpt', required=True, help='The path to the latest checkpoint weights for your model.')
...
parser.add_argument('--model', type=str, default='FC-DenseNet103', required=True, help='The model you are using')
